...
export default function App() {
  ...
  if (!license?.activated) return <ActivationScreen onActivated={setLicense} error={license?.error === 'otro_equipo' ? 'Esta licencia está activada en otro equipo.' : undefined} />;
