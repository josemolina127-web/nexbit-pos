...
const darkVars = {
  ...
  '--border': '#2a2a2a', '--text': '#ffffff', '--textSecondary': '#a0a0a0',
  '--textMuted': '#666666', '--primary': '#FF4B00', '--primaryHover': '#e04400',
  ...
  '--sidebarBg': '#050505', '--sidebarText': '#888888',
...
const lightVars = {
  ...
  '--text': '#1a1a2e', '--textSecondary': '#4a4a6a', '--textMuted': '#7a7a9a',
  ...
  '--sidebarText': '#4a4a6a', '--sidebarActive': '#FF4B00',
